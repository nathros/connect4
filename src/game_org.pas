...
type
  ...
  private
    ...
    function ChooseBest(ResultList: array of integer): integer;
  public
    Settings: TSettings;
...
var
  TempGrid: TGrid;
  MoveResults: array[1..7] of integer;
  i, y: integer;
begin
  TempGrid:=MovesGrid;
      ...
      if y=0 then
        ...
        begin
          ...
          if IsWin(x,y,Player,CurrentGrid) then
            begin
              if Player=PlayerGo then MoveStats[x]:=42
              else MoveStats[x]:=-42;
            end
...
//----------------------------------------------------------------------------//
function TGame.ChooseBest(ResultList: array of integer): integer;
var
  x, y, i, count: integer;
